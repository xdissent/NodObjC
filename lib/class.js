...
function getClass (className) {
  ...
  return core.objc_getClass(className)
}
...
proto.extend = function extend (className, extraBytes) {
  var c = core.objc_allocateClassPair(pointer, className, extraBytes || 0)
  if (!c) {
...
/**
 * Get's the Class instance's superclass. If the current class is the
