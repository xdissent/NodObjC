...
// just a few typedefs
var uintptr_t = ref.sizeof.pointer === 8 ? 'uint64' : 'uint32'
...
var objc = new ffi.Library('libobjc', {
...
exports.TYPE_SIZE_MAP = ref.sizeof
...
exports.objc_method_description = Struct({
    'name': POINTER
  , 'types': 'string'
})
