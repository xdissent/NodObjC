 ...
 * try {
 *
 *   // This will throw an exception since you can't add `nil` to an NSArray
...
var Exception = require('vm').runInNewContext('Error')
  , proto = exports.proto = Exception.prototype
  , id = require('./id')
...
function wrap (pointer, constructorOpt) {
  var w = id.wrap(pointer)
  w.__proto__ = proto
  // `name` is non-configurable on Functions in V8, so don't bother
  w.message = w('reason')('UTF8String')
  Error.captureStackTrace(w, constructorOpt || exports.wrap)
  return w
}
...
proto.toString = function toString () {
  return this('name')('UTF8String') + ': ' + this('reason')('UTF8String')
}
